    ...
    <div className="mx-auto max-w-[var(--container-max)] px-[var(--container-padding)] py-8 md:py-14">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          <div className="rounded-xl border border-border-subtle bg-bg-card p-6">
            ...
            <div className="space-y-3 text-xs text-text-secondary leading-relaxed">
              <p>
                <span className="text-accent-yellow-text font-medium">Тиерная лояльность:</span> кэшбэк растёт с покупками — от 2% (Старт) до 7% (Платина, от 1 млн ₽).
                Клиент на уровне Золото (5%) не уйдёт к конкуренту, который даёт 2%.
              </p>
              <p>
      ...
      <section className="mb-14 md:mb-20">
        ...
        <div className="grid gap-3 md:grid-cols-2">
          {[
            ...
            { title: 'Личный кабинет', description: 'История заказов со статусами, бонусный уровень с прогресс-баром, реферальная программа (500₽ + 1% пожизненно), повтор заказа, профиль.', status: 'live' as const },
            { title: 'Тиерная бонусная программа', description: 'Растущий кэшбэк: Старт 2% — Серебро 3% (от 500K) — Золото 5% (от 700K) — Платина 7% (от 1 млн ₽). Реферальная программа: 500₽ за первую покупку друга + 1% с каждой покупки пожизненно.', status: 'live' as const },
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-accent-yellow/20 bg-accent-yellow/5 p-5 md:p-6">
            ...
            <p className="text-[10px] text-text-muted mt-4 border-t border-accent-yellow/10 pt-3">
              Обратите внимание: кэшбэк начисляется автоматически после оплаты (от 2% до 7%). Реферальная программа: 500₽ за первую покупку друга + 1% с каждой его покупки пожизненно.
            </p>
          </div>
      ...
      <section className="mb-14 md:mb-20">
        ...
        <div className="grid gap-4 sm:grid-cols-4 mb-6">
          {[
            { value: '35 000+', label: 'строк кода', sub: '218 файлов, 107 коммитов' },
            { value: '668', label: 'тестов', sub: '46 unit suites + 48 E2E' },
        ...
        <div className="rounded-xl border border-border-subtle bg-bg-card overflow-hidden">
          {[
            ...
            { label: 'Тесты', value: '620 unit-тестов (Vitest, 46 suites) + 48 E2E (Playwright), 100% покрытие API' },
        ...
        <div className="rounded-xl border border-border-subtle bg-bg-card p-5 mt-6">
          ...
          <div className="text-xs text-text-secondary leading-relaxed space-y-1.5 select-all">
            ...
            <p>35 000+ строк кода, 218 файлов, 107 коммитов. 34 API-эндпоинта, 42 страницы, 21 таблица в БД. 668 автотестов (46 unit suites + 48 E2E), 100% покрытие API.</p>
